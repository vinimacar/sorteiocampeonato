  ...
  gruposSorteados.forEach((grupo, idx) => {
    ...
    for (let i = 0; i < grupo.length; i++) {
      for (let j = i + 1; j < grupo.length; j++) {
        jogos.push(
          `<img src="https://flagcdn.com/w64/${grupo[i].codigo}.png" width="24" alt="${grupo[i].nome}"> ${grupo[i].nome} x 
           <img src="https://flagcdn.com/w64/${grupo[j].codigo}.png" width="24" alt="${grupo[j].nome}"> ${grupo[j].nome}`
        );
      }
    }
